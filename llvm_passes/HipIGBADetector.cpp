...
// integer (which OTOH is loaded from somewhere). The analysis is very simple
// and naive: we look for pointer load and inttoptr instructions. If we see any
// we conclude there are potential IGBAs. Downsides of this are that
//
